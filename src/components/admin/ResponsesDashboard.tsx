            ...
            <form onSubmit={handleEmailLogin} className="space-y-4 text-left">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-xs font-medium focus:ring-2 focus:ring-nl-petrol bg-slate-50 focus:bg-white"
                  required
                />
              </div>
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl bg-nl-petrol hover:bg-nl-petrol-dark text-white font-bold text-xs flex items-center justify-center gap-2 shadow transition-all cursor-pointer disabled:opacity-60"
              >
                <KeyRound className="w-4 h-4" />
                <span>{authLoading ? 'Verificando credenciales...' : 'Ingresar al Panel de Respuestas'}</span>
              </button>
            </form>
